 ...
 <br>
	...
	<div class="row">
		<div class="col-md-8 osntext pr-md-5">
			 <?$APPLICATION->IncludeFile($APPLICATION->GetCurDir()."block_1.php"); //преимущества?> <?$APPLICATION->IncludeFile($APPLICATION->GetCurDir()."block_2.php"); //бренды?> <?$APPLICATION->IncludeFile($APPLICATION->GetCurDir()."block_3.php"); //Отзывы?> <?$APPLICATION->IncludeFile($APPLICATION->GetCurDir()."block_4.php"); //Карта?> <?$APPLICATION->IncludeFile($APPLICATION->GetCurDir()."block_5.php"); //Форма?>
		</div>
		<div class="col-md-1 d-none d-md-block">
		</div>
		<div class="col-md-3 d-none d-md-block anchor_next_recomend pl-md-2">
			 <?$APPLICATION->IncludeFile($APPLICATION->GetCurDir()."recomend.php"); //рекомендуем?>
		</div>
	</div>
</div>
 <style>
...
</script> <?\CJSCore::init("sidepanel");?> <script>
$(document).on('click','#listdilers',function(){
	BX.SidePanel.Instance.open(	"magazins_table.php");
});
