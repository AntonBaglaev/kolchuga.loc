...
<div id="filter" class="clearfix">
    <form class="b-filter" name="<? echo $arResult["FILTER_NAME"] . "_form" ?>"
                ...
                if($arItem['DISPLAY_TYPE'] !== 'A' && $arItem['DISPLAY_TYPE'] !== 'B'){
                    ...
                    <div class="b-filter__item">
                        ...
                        <div class="b-filter-options filter_opt">
							...
							<?//echo '<script>console.log('.json_encode($arValue).')</script>';?>
        ...
        <div class="b-filter__row filter_result filter_result_cur b-ffr">
            ...
            <div class="filter_result_2"><input class="submit" type="submit" name="set_filter" value="Показать" style="display: none;"><a class="submit reset" href="<?= $APPLICATION->GetCurPage(); ?>" class="submit">
                Сбросить
            </a></div>
        </div>
    </form>
