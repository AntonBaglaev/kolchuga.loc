<?php
      ...
      !empty($arParams["SET_GLOBAL_SECTION_ID"]))
  {
	...
	if (!empty($arResult['BRAND_VALUE']['VALUE']))
    {
      $GLOBALS[$arParams["SET_GLOBAL_SECTION_ID"]]['PROPERTY_BREND_VALUE'] = $arResult['BRAND_VALUE']['VALUE'];
    }
	if (!empty($arResult['KALIBR_VALUE']['VALUE']))
    {
      $GLOBALS[$arParams["SET_GLOBAL_SECTION_ID"]]['PROPERTY_KALIBR'] = $arResult['KALIBR_VALUE']['VALUE'][0];
    }
	
	if ($arResult['SECTION']['PATH'][0]['ID']==17827)
    {
      $GLOBALS[$arParams["SET_GLOBAL_SECTION_ID"]]['RAZDEL'] = 17827;
    }
	
   /*?><!--pre>arResultDelElementSimilar <?print_r($arResult);?></pre--><?*/
  }
