...
$APPLICATION->IncludeComponent("bitrix:catalog.search", "catalog_search_v2", array(
		"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
		"IBLOCK_ID" => $arParams["IBLOCK_ID"],
		...
		"USE_SEARCH_RESULT_ORDER" => !empty($arParams["USE_SEARCH_RESULT_ORDER"]) ? $arParams["USE_SEARCH_RESULT_ORDER"] : "Y",
