...
$MESS['SOA_TEMPL_PROP_CHOOSE_TITLE'] = "Информация для оплаты и доставки заказа";
...
$MESS['SOA_TEMPL_ORDER_SUC0'] = "Ожидайте письмо с информацией о вашем заказе на вашу электронную почту.";
$MESS['SOA_TEMPL_ORDER_SUC00'] = "Ожидайте письмо с сылкой на оплату заказа на вашу электронную почту.";
$MESS['SOA_TEMPL_ORDER_SUC1'] = "Вы можете следить за выполнением своего заказа в <a style=\"text-decoration: underline;\" href=\"#LINK#\">Персональном разделе сайта</a>. Обратите внимание, что для входа в этот раздел вам необходимо будет ввести логин и пароль пользователя сайта.";
...
$MESS['SOA_TEMPL_PAY_PDF'] = "<br><a class=\"btn btn-primary\" href=\"#LINK#\" target=\"_blank\">Скачать счет</a>";
...
$MESS['SOA_TEMPL_ORDER_COMPLETE'] = "Спасибо, Ваш заказ сформирован";
...
$MESS['SOA_HAS_ONLINE_UNAVAILABLE'] = "Товары, недоступные для онлайн оплаты, могут быть оплачены Вами после согласования с менеджером";
?>