<?
$MESS['SALE_TITLE_STEP_1'] = 'В корзине';
$MESS['SALE_TITLE_STEP_2'] = 'Доставка';
$MESS['SALE_TITLE_STEP_3'] = 'Оплата';

$MESS['SALE_COUNT_5'] = 'товаров';
$MESS['SALE_COUNT_1'] = 'товар';
$MESS['SALE_COUNT_2'] = 'товара';
...
$MESS["SALE_ADD"] = "В корзину";

$MESS["SALE_COUPON"] = "Код купона на скидку";
$MESS["SALE_COUPON_CANCEL"] = "Отменить купон";

$MESS["SALE_NO_DISCOUNT"] = "Сумма заказа:";
$MESS["SALE_DISCOUNT"] = "Скидка:";
$MESS["SALE_TOTAL"] = "Итого:";

$MESS['SALE_W_DISCOUNT'] = 'Цена с учетом скидки';

$MESS["SALE_TO_CATALOG"] = 'Продолжить покупки';
$MESS["SALE_NEXT_STEP"] = 'Следующий шаг';
...
$MESS["SALE_NO_ITEMS"] = "<p>Сейчас ваша корзина пуста.</p>
        <p>Если вы хотите сделать заказ в нашем магазине, Вы можете перейти на страницу
        <a href=\"/catalog/\">каталога</a> и добавить товары в корзину </p>";
$MESS["SALE_NO_DELAY"] = '<p>Чтобы добавить товары в "Избранное" перейдите на <a href="/personal/cart/">страницу корзины</a></p>';
