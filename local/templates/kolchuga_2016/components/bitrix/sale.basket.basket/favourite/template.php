...
if (!$arResult['ITEMS']['DelDelCanBuy']): ?>
    <div class="alert alert-danger"><?=GetMessage('SALE_NO_DELAY')?></div>
<? return false;
endif ?>
    ...
    <table class="table table__goods table__basket js-basket-table">
        ...
        <tr class="js-row" data-id="<?=$arItem['ID']?>">
            ...
            <td class="td__doing">
                ...
                <div class="td__inner">
                    <a class="td__doing--favourite" href="?<?=$arParams["ACTION_VARIABLE"]?>=add&id=<?=$arItem['ID']?>" title="<?=GetMessage('SALE_DELAY')?>">
                        <span class="icon-shopping-bag"></span>
                        <i><?=GetMessage('SALE_ADD')?></i>
                    </a>
