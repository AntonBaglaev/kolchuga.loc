$(function(){
   ...
   /*  var objMenu = $(".aim_catalog>ul, .aim_catalog>ul>li>ul");
	...
	/* $('.navbar__nav .aim_catalog').hover(function() {
		$('ul.vipad' ).css( {'display':'flex'} );	  
	  }, function() {
		$('ul.vipad' ).css( {'display':'none'} );	  
	  }
	  ); */

});
$(document).on('click','label.ur_1',function(){
	$('.navbar__nav input.toggleSubmenu').attr('checked',false);	
});