...
?>
<div id="modal-buyoneclick-list" class="mfp-modal mfp-hide">
    ...
    <div class="mfp-modal-content js-modal-reserve">
        ...
        <div class="form__horizontal">
                ...
                <div class="form__group">
                    ...
                    <div class="form__input">
                        ...
                        <?else:?>
                            ...
                            <select name="form_<?= $field['FIELD_TYPE'] ?>_<?= $field['ID'] ?>" class="select_store_list">
            ...
            <div class="form__group form__group--nolabel">
				...
				<input type="hidden" name="form_hidden_listid" class="form_hidden_listid" value="">
                    <input type="button" class="btn btn-primary web_form_submit_reserv" name="web_form_submit" value="Зарезервировать">
                </div>
            </div>
        </div>
