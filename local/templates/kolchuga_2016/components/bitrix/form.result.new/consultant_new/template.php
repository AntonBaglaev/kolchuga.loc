...
/*        display: block!important;*/
    ...
    <div id="modal-consultant-btn" class="mfp-modal-btn effect-shadow">
        <div class="mfp-modal-header mfp-modal-header-left-img">
        </div>
    </div>
        ...
        <div class="form__horizontal">
            ...
            <div class="form__group">
                <label class="label--checkbox label--checkbox__consul">
                    <input type="checkbox" name="form_text_28" value="1" checked="checked">
                    <p class="form__group_cons">Подтверждаю согласие на обработку <a href="/information/politika-konfidentsialnosti.php">персональных данных</a>
