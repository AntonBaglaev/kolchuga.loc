...
function consultant_fadeInPopUp(form_class){
    ...
    $('.mfp-modal-header-left-img').parent('#modal-consultant-btn').fadeOut(0);
}
...
;(function($){
    ...
    $(document).ready(function(){
        ...
        $('.close-consultant').on('click', function(){
                consultant_setCookie('consultant_hide', 1);
                $('#modal-consultant').addClass('mfp-hide');
                $('#modal-consultant-btn').fadeIn(0);

            });
        $('#modal-consultant-btn').click(function(){
            $(this).fadeOut(0);
            $('#modal-consultant').removeClass('mfp-hide');
        });
