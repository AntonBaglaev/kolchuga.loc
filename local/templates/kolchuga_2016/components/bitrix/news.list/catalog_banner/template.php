...
<div class="container-fluid">
	<div class="row">
		<?if(!empty($arItem['PREVIEW_TEXT'])){?>
			<div class="col-12 mb-3 mt-3 mlh pl10 pr0">
				<p style="text-align:center;color: #F14E4A;"><?=$arItem['PREVIEW_TEXT']?></p>
			</div>
		<?}else{?>
			<?if(!empty($arItem['DETAIL_PICTURE']['SRC'])){?>
				<div class="col-12 mb-3 mt-3 mlh pl10 pr0 text-center d-none d-md-block">
					<?
			...
			<?if(!empty($arItem['PREVIEW_PICTURE']['SRC'])){?>
				<div class="col-12 mb-3 mt-3 mlh pl10 pr0 text-center d-block d-md-none">
					<?
