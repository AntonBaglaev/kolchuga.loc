...
?><div class="salon_list">
	<div class="table_salon_list row"><?
...
foreach($arResult["ITEMS"] as $arItem)
{
	...
	if(is_array($arItem))
	{
		if($arItem['PROPERTIES']['show_in_list']['VALUE_XML_ID'] != 'NO')
		{
			...
			<div class="table_salon_list_td2 col-12 col-md-6 col-lg-4 " id="<?=$this->GetEditAreaId($arItem['ID']);?>">
			...
			$counter++;
			if($counter % 2 == 0){
				echo '<hr class="tr_border d-none d-md-block d-lg-none bx-clear col-12 pt-5 mb-5">';
			}
			if($counter % 3 == 0){
				echo '<hr class="tr_border d-none d-lg-block bx-clear col-12 pt-5 mb-5">';
			}
		}
	}
}
