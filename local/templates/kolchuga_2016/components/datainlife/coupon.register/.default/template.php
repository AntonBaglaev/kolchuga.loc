...
<div class="discount">
    ...
    <? if($arResult['TEMPLATE_PART'] == 'CREATE'): ?>
        <div class="discount__query">
            <div class="discount__query--left">
                ...
                <div class="discount__card--list">
                    <ul>
                        <li><img src="<?=$templateFolder?>/images/card3p.png" alt=""></li>
                        <li><img src="<?=$templateFolder?>/images/card5p.png" alt=""></li>
                        <li><img src="<?=$templateFolder?>/images/card10p.png" alt=""></li>
                    </ul>
                </div>
        ...
        <div class="discount__result">
            ...
            <div class="discount__card">
                <div class="discount__card--inner">
                    <? if($arResult['TEMPLATE_PART'] == 'SUCCESS'):
                        $img_name = 'card' . explode('_', $arResult['COUPON']['STATUS_CODE'])[1] . 'p.png';
                    ?>
			...
			<?if($arResult['TEMPLATE_PART'] == 'SUCCESS'){?>
				<div class="main__btn"><a href="javascript:void(0);" data-sesias='<?=$arResult['COUPON']['HASH']?>'>У меня изменился номер карты</a></div>
