...
$MESS["AUTH_NO_REGISTER"] = "Не зарегистрированы на сайте?";
$MESS["AUTH_AFTER_REGISTER"] = "После регистрации на сайте Вам будет доступно отслеживание состояния заказов, онлайн-оплата заказа, личный кабинет, возможность использовать вашу скидочную карту и другие новые возможности.";
?>
