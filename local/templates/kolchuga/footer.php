	...
	<div class="botgal center"><div class="content">
	...
	<div class="footer color_white">
		<div class="footer_body">
			...
			<div class="footer-col">
				<div class="footer-header">œŒÀ≈«Õ¿ﬂ »Õ‘Œ–Ã¿÷»ﬂ</div>
				<?$APPLICATION->IncludeComponent(
					"bitrix:menu",
					"footer",
					Array(
			...
			<div class="footer-col">
				<div class="footer-header">œŒ ”œ¿“≈ÀﬂÃ</div>
	...
	"ACTIVE_COMPONENT" => "Y"
			...
			<div class="footer-col">
				<div class="footer-header"> ŒÕ“¿ “€</div>
				<div class="address">
					<?$APPLICATION->IncludeComponent(
						"bitrix:main.include",
						"",
