...
<? if ($arResult['ITEMS']): ?>
    ...
    <h2 class="vk_h2">Мы ВКонтакте <div class="vk_post-h2"><a href="https://vk.com/kolchugashop" target="_blank">Все публикации</a></div></h2>

    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        <? foreach ($arResult['ITEMS'] as $arItem): ?>
            <div class="col vk_post-item">
                <div class="card shadow-sm vk_post-card">

                    <div class="vk_post-card-header">
                        <div class="vk_post-card-logo"><a href="https://vk.com/kolchugashop" target="_blank"><img
                                        src="/images/vk_logo.png"></a></div>
                        <a href="https://vk.com/kolchugashop" target="_blank" class="vk_post-card-title">Оружейные
                            салоны «Кольчуга»</a>

                        <a href="<?= $arItem['link'] ?>" target="_blank" class="vk_post-card-subtitle"><?= FormatDate("j F Y", $arItem['date']) ?></a>
                        <div class="_clearfix"></div>
                    </div>

                    <div class="vk_post-card-body">
                        <p class="vk_post-text"><?= $arItem['text'] ?></p>
                    </div>

                    <? if ($arItem['photo']): ?>
                        <div class="vk_post-photo"><a href="<?= $arItem['link'] ?>" target="_blank"><img src="<?= $arItem['photo'] ?>"></a>
                        </div>
                    <? endif ?>

                    <? if ($arItem['video']['player']): ?>
                        <div class="vk_post-video">
                            <iframe src="<?= $arItem['video']['player'] ?>" width="368"
                                    height="<?= round(368 * $arItem['video']['height'] / $arItem['video']['width']) ?>"
                                    frameborder="0"
                                    allowfullscreen="1"
                    ...
                    <a href="<?= $arItem['link'] ?>" target="_blank" class="vk_post-card-bottom">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex justify-content-between align-items-center vk_post-card-bottom_likes">
                                <div class="vk_post-card-icon-wrapper mr-3" title="Понравилось">
                                    <div class="vk_post-card-icon">
                                    ...
                                    </div><?= $arItem['likes'] ?: '0' ?></div>
                                <div class="vk_post-card-icon-wrapper mr-3" title="Прокомментировали">
                                    <div class="vk_post-card-icon">
                                        <svg height="24" viewBox="0 0 24 24" width="24"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <g fill="none" fill-rule="evenodd">
                                    ...
                                    </div><?= $arItem['comments'] ?: '0' ?></div>
                                <div class="vk_post-card-icon-wrapper mr-3" title="Поделились">
                                    <div class="vk_post-card-icon">
                                        <svg height="24" viewBox="0 0 24 24" width="24"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <g fill="none" fill-rule="evenodd">
                                    ...
                                    </div><?= $arItem['reposts'] ?: '0' ?></div>
                            </div>
                            <div class="vk_post-card-icon-wrapper-views" title="Просмотров">
                                <div class="vk_post-card-icon">
