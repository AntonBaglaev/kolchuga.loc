	...
	else
	{
		...
		while($arSection = $rsSections->GetNext())
		{
			$arResult["SECTIONS"][] = array(
				...
				"UF_PERSONAL_CLASS" => $arSection["UF_PERSONAL_CLASS"],
				"UF_ALT_SORT" => $arSection["UF_ALT_SORT"],
				"UF_DOP_INFO_MENU" => $arSection["UF_DOP_INFO_MENU"],
			);
...
foreach($arResult["SECTIONS"] as $arSection)
{
	...
	$aMenuLinksNew[$menuIndex++] = array(
		...
		array(
			...
			"IS_PARENT" => false,
			"DEPTH_LEVEL" => $arSection["DEPTH_LEVEL"],
			"PERSONAL_CLASS" => $arSection["UF_PERSONAL_CLASS"],
			"ALT_SORT" => $arSection["UF_ALT_SORT"],
			"SORT" => $arSection["SORT"],
			"DOP_INFO_MENU" => $arSection["UF_DOP_INFO_MENU"],
		),
	);
}
