...
$arParams["IBLOCK_TYPE"] = ((!empty($arParams["IBLOCK_TYPE"]))? trim($arParams["IBLOCK_TYPE"]) : "");
...
$arParams["FILTER_NAME"] = ((!empty($arParams["FILTER_NAME"]))? trim($arParams["FILTER_NAME"]) : "");
$arFilter_ = array();

  if (!empty($arParams["FILTER_NAME"]) &&
      is_array($GLOBALS[$arParams["FILTER_NAME"]]))
  {
    $arFilter_ = $GLOBALS[$arParams["FILTER_NAME"]];
  }
...
if($this->startResultCache(false, ($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups()).serialize($arFilter_)))
{
  ...
  if (!empty($arFilter_ ) &&
      is_array($arFilter_ ))
  {
    $arFilter = array_merge($arFilter, $arFilter_);
  }
