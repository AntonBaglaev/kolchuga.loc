...
class Options extends TradingService\Common\Options
{
	...
	public function getTabs()
	{
		return [
			'COMMON' => [
				'name' => static::getLang('TRADING_SERVICE_BERU_TAB_COMMON'),
				'sort' => 1000,
			],
			'STORE' => [
				'name' => static::getLang('TRADING_SERVICE_BERU_TAB_STORE'),
				'sort' => 2000,
			],
			'STATUS' => [
				'name' => static::getLang('TRADING_SERVICE_BERU_TAB_STATUS'),
				'sort' => 3000,
				'data' => [
					'WARNING' => static::getLang('TRADING_SERVICE_BERU_TAB_STATUS_NOTE'),
				]
			],
		];
	}
	...
	protected function getOrderPersonFields(TradingEntity\Reference\Environment $environment, $siteId)
	{
		...
		$overrides = [
			'GROUP' => static::getLang('TRADING_SERVICE_BERU_GROUP_ORDER'),
			'GROUP_DESCRIPTION' => static::getLang('TRADING_SERVICE_BERU_GROUP_ORDER_DESCRIPTION'),
			'SORT' => 3200,
		];
		...
		try
		{
			...
			$result = [
				'PAY_SYSTEM_ID' => [
					...
					'NAME' => static::getLang('TRADING_SERVICE_BERU_OPTION_PAY_SYSTEM_ID'),
					'GROUP' => static::getLang('TRADING_SERVICE_BERU_GROUP_ORDER'),
					'GROUP_DESCRIPTION' => static::getLang('TRADING_SERVICE_BERU_GROUP_ORDER_DESCRIPTION'),
		...
		try
		{
			...
			$result = [
				'DELIVERY_ID' => [
					...
					'NAME' => static::getLang('TRADING_SERVICE_BERU_OPTION_DELIVERY_ID'),
					'GROUP' => static::getLang('TRADING_SERVICE_BERU_GROUP_ORDER'),
					'GROUP_DESCRIPTION' => static::getLang('TRADING_SERVICE_BERU_GROUP_ORDER_DESCRIPTION'),
					'VALUES' => $deliveryEnum,
					'SETTINGS' => [
