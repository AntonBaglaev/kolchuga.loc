...
class PaySystem
{
	...
	public function getTypeTitle($type, $version = '')
	{
		...
		return static::getLang('TRADING_SERVICE_BERU_PAY_SYSTEM_TYPE_' . $typeKey . $versionSuffix, null, $type);
	}
	...
	public static function getMethodTitle($method, $version = '')
	{
		...
		return static::getLang('TRADING_SERVICE_BERU_PAY_SYSTEM_METHOD_' . $methodKey . $versionSuffix, null, $method);
	}
}