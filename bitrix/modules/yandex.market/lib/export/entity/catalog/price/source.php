...
class Source extends Market\Export\Entity\Reference\Source
{
	...
	protected function isNeedDiscountCache($select, $context)
	{
		...
		{
			$result = \CIBlockPriceTools::SetCatalogDiscountCache($priceIds, $context['USER_GROUPS'], $context['SITE_ID']);
		}
	...
	protected function getElementOptimalPrice($element, $fields, $elementPrices, $context)
	{
		...
		$result = \CCatalogProduct::GetOptimalPrice($element['ID'], $quantity, $context['USER_GROUPS'], 'N', $elementPrices, $context['SITE_ID']);
