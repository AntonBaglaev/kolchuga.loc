...
<div class="b-filter-condition-fields">
	...
	<div class="b-filter-condition-field type--value js-condition-item__value-cell <?= $selectedCompareDefined !== null ? 'visible--hidden' : ''; ?>">
		...
		else if ($valueEnum !== null || $isSelectedCompareMultiple || $isSelectedFieldAutocomplete)
		{
			...
			?>
			<select class="b-filter-condition-field__input js-condition-item__input js-condition-item__value js-plugin-delayed" <?= $isSelectedCompareMultiple ? 'multiple' : ''; ?> size="1" data-plugin="Ui.Input.FilterInput" data-name="VALUE" <?
