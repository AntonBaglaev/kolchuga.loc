...
<tr>
	<td valign="top">
		<span class="required">*</span><?=Loc::getMessage('PP_ENCLOSING_TYPES_SELECTED');?>:<br>
		<img src="/bitrix/images/sale/mouse.gif" width="44" height="21" border="0" alt="" />
	</td>
	<td valign="top">
...
<tr>
	<td colspan="2" align="center">
		<?// arFields and arFieldsName defined in ./fields.php?>
		<script>
		...
		foreach ($personType as $val) {
			...
			<table class="internal" width="80%">
				...
				<?$arSelected = (!empty($arTableOptions[$val['ID']]['ORDER_LOCATION']) && count($arTableOptions[$val['ID']]['ORDER_LOCATION']))
				...
				<?$arSelected = (!empty($arTableOptions[$val['ID']]['ORDER_PHONE']) && count($arTableOptions[$val['ID']]['ORDER_PHONE']))
				...
				<?$arSelected = (!empty($arTableOptions[$val['ID']]['FIO']) && count($arTableOptions[$val['ID']]['FIO']))
				...
				<?$arSelected = (!empty($arTableOptions[$val['ID']]['EMAIL']) && count($arTableOptions[$val['ID']]['EMAIL']))
