...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/company/staff/index.php", array("STAFF_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/search/index.php", array("STAFF_IBLOCK_ID" => $iblockID));