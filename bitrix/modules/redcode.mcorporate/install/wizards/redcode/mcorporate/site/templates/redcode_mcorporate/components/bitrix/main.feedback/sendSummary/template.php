	...
	<div class="modalWrapper">
		...
		<div class="modalFooter">
			<div class="buttonAnimation">
				...
				<input type="submit" disabled data-file="<?=GetMessage("SEND_SUMMARY_SET_FILE")?>" data-text="<?=$arParams["FORM_NAME_SUBMIT"];?>" value="<?=GetMessage("SEND_SUMMARY_SET_FILE")?>" class="disabled modalSend" />
