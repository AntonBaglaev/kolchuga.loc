...
<div>
<div class="dib">
<h2 class="color_blue"><?= GetMessage("SALE_OTLOG_TITLE")?></h2>
...
<br />
<div width="30%">
	<div class="p"><div class="button_blue">
	<input type="submit" value="<?= GetMessage("SALE_REFRESH")?>" name="BasketRefresh"></div></div>
