				...
				<thead>
					...
					<tr>
						...
						<td>
							...
							<select style="width: 16px; display: none;" id="number_goods" class="chzn-select" name="namenumber_goods">
								<option value="6"<?if($_COOKIE['PAGE_ELEMENT_COUNT'] == 6):?> SELECTED<?endif;?>>по 6</option>
						...
						<td>
							<div class="submit_blue">
								<input type="submit" name="set_filter" value="Фильтр" /><input type="hidden" name="set_filter" value="Y" />
							</div>  
							<div class="submit_blue">
