...
<div class="yandex-share-panel <?=$arParams["TEXT_ALIGN"]?>">
	<?if(trim($arParams["TEXT_BEFORE"])):?><div class="ya-share-text-wrap"><img src="<?php echo SITE_TEMPLATE_PATH ?>/images/new-img-item-catalog/share-ico.svg"><?=$arParams["TEXT_BEFORE"]?></div><?endif;?>
