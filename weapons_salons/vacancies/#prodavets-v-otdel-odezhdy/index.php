...
?><div class="container-fluid pb-5">
	<div class="row">
		<div class="rowanons col-md-6 order-2 mt-4 mt-md-0">
			<h1>Продавец в отдел одежды</h1>
			<div class="osnanons">
				<p>
					 В оружейные салоны «Кольчуга» требуются продавцы-консультанты&nbsp;в отдел одежды:
				</p>
			</div>
		</div>
		<div class="col-md-6 order-1 order-md-2">
 <img alt="prodavec_odezhda_1.jpg" src="/upload/medialibrary/59d/59d3cb7c75931ce19837eea0300d9ec6.jpg" title="prodavec_odezhda_1.jpg">
		</div>
	</div>
 ...
 <b>Обязанности:</b>
			...
			<ul>
				<li>Консультирование клиентов по товарному ассортименту, характеристикам товара, дополнительным услугам, сервисам и действующим рекламным акциям магазина;<br>
 </li>
				<li>Продажа товаров известных брендов (одежда, обувь, рюкзаки, туалетная вода, различные аксессуары для активного отдыха, охоты, рыбалки);<br>
 </li>
				<li>Размещение товара в торговом зале;<br>
 </li>
				<li>Участие в приёме товара;<br>
 </li>
				<li>Участие в проведении инвентаризации;<br>
 </li>
				<li>Участие в рекламных акциях;<br>
 </li>
				<li>Ежегодное участие в международной выставке ARMS &amp; HUNTING.<br>
 </li>
			</ul>
			<p>
 <b>Требования:</b>
			...
			<ul>
				<li>Клиентоориентированность, активная жизненная позиция, позитивный настрой, хорошие коммуникативные навыки, внимательность, пунктуальность, исполнительность, неконфликтность;<br>
 </li>
				<li>Мотивация к обучению и развитию своих профессиональных навыков;<br>
 </li>
				<li>Мы готовы рассмотреть кандидатов без опыта работы, но с желанием работать в стабильной активно развивающейся известной компании.</li>
			</ul>
			<p>
 <b>Условия:</b>
			</p>
			<ul>
				<li>Интересная работа с мировыми брендами такими как Beretta, Blaser, Sportchief, Habsburg и многие другие в стабильной, динамичной компании (компания на рынке с 1994 года);<br>
 </li>
				<li>График работы: 8 часовой рабочий день - с 9:45 до 19:00 или с 10:45 до 20:00, выходные дни по скользящему графику;<br>
 </li>
				<li>Проводится обучение (стажировка). В период обучения выплачивается стипендия;<br>
 </li>
				<li>Стабильная официальная заработная плата выплачивается каждые две недели;<br>
 </li>
				<li>Квартальные и годовые премии по результатам работы;<br>
 </li>
				<li>Комфортные условия работы;<br>
 </li>
				<li>Оформление согласно трудовому законодательству РФ;<br>
 </li>
				<li>Возможность карьерного роста и профессионального развития;<br>
 </li>
				<li>Скидки для сотрудников на продукцию во всех салонах компании<br>
 </li>
			</ul>
 <br>
		</div>
