...
$APPLICATION->SetTitle("Мастер по ремонту оружия");
?><div class="container-fluid pb-5">
	<div class="row">
		<div class="rowanons col-md-6 order-2 mt-4 mt-md-0">
			<h1>Мастер по ремонту оружия</h1>
			<div class="osnanons">
				<p>
					 В сервисные центры «Кольчуга» требуются мастера по ремонту оружия:
				</p>
			</div>
		</div>
		<div class="col-md-6 order-1 order-md-2">
 <img alt="master_remont.jpg" src="/upload/medialibrary/332/33261112d623d82dc4a6cec9427f1566.jpg" title="master_remont.jpg">
		</div>
	</div>
 ...
 <b>Обязанности:</b>
			...
			<ul>
				<li>Проведение полного спектра ремонтных и профилактических работ пневматического и огнестрельного оружия.</li>
				<li>Адаптация прицелов к оружию.</li>
				<li>Консультации посетителей магазина по вопросам назначения, свойств, правил ухода за оружием;</li>
				<li>Предпродажная подготовка оружия;</li>
				<li>Обслуживание клиентов, обратившихся в мастерскую по гарантии;</li>
				<li>Участие в инвентаризации товарно-материальных ценностей.</li>
			</ul>
			<p>
 <b>Требования:</b>
			</p>
			<ul>
				<li>Навыки работы с гражданским, служебным, спортивным оружием.</li>
				<li>Техническое образование.</li>
				<li>Увлечённость оружейной тематикой.</li>
				<li>Желание развиваться по профессии мастера-оружейника.</li>
 ...
 <b>Условия:</b>
			...
			<ul>
				<li>Работа в крупнейшем оружейном холдинге.</li>
