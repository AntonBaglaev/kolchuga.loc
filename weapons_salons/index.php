...
?>
<div class=" mb-5 wsalon">
	<div class="row">	
		<div class="col-lg-6">
			<div class="row">
				<div class="col-12"><p class="grey5c">Не каждый оружейный магазин в Москве сможет сравниться с оружейными салонами «Кольчуга» по уровню сервиса, ассортименту и удобству локаций. Мы предлагаем прекрасный выбор товаров для охоты, спортивной стрельбы и активного отдыха от ведущих зарубежных брендов.</p> </div>
			</div>			
		</div>
		<div class="col-lg-6">
			<div class="row">
				<div class="col-lg-6">
					<?/* <div class="main__btn mapbtn"><a href="#map">Салоны на карте</a></div> */?>
				</div>
				<div class="col-lg-6">
					<div class="main__btn mapbtn"><a href="#map">Салоны на карте</a></div>				
					<?/* <small><div class="card">
					  <!-- Default panel contents -->
						<div class="card-header text-center">График работы салонов:</div>
							<!-- List group -->
...
$result_page = array_filter($requestArr, function($key){
                 return preg_match("/^PAGEN_\d+$/", $key);
             }, 
...
?>
<script>console.log(<?echo json_encode($result_page)?>);</script>
