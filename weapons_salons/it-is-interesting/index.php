...
$APPLICATION->SetPageProperty("keywords", "фильмы об охоте, охотничьи традиции, анекдоты, тосты, фотогалерея, инструкции,");
$APPLICATION->SetPageProperty("description", "Информация для охотников, статьи про оружие, охотничьи традиции");
