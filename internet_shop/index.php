...
if(!isset($_REQUEST['q']) && preg_match('/[-]+/', $pageUrl)){
...
<p style="text-align:center;">
	...
	<span style="color: #F14E4A;">Спасибо за ваши заказы, их очень много! Мы обработаем и передадим в курьерскую службу все заказы в течение 7 рабочих дней после оплаты! Заказы, сделанные 25 декабря и позже, будут доставлены в январе 2021 года.</span>
</p>

<p style="text-align:center;">
	<span style="color: #F14E4A;">Уважаемые клиенты! </span><br><br>
	<span style="color: #F14E4A;">Спасибо за заказы! Их очень много) Мы временно увеличили срок обработки заказов до 5 дней.</span>
</p>*/?>
</noindex>
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"DETAIL_PROPERTY_CODE" => array(
			...
			7 => "RAZMER",
			8 => "CML2_BAR_CODE",
			9 => "DIAMETR_VYKHODNOGO_ZRACHKA_MM_1",
			10 => "MATERIAL",
			11 => "TSVET",
			12 => "SEZON",
			13 => "WE_RECOMEND_WITH_IT",
			14 => "MASSA_G",
			15 => "UVELICHENIE_KRATNOST",
			16 => "UGLOVOE_POLE_ZRENIYA",
			17 => "DIAMETR_VYKHODNOGO_ZRACHKA_MM",
			18 => "DIAMETR_OBEKTIVA_MM",
			19 => "TSVET_1",
			20 => "",
		),
